...
1. **[CORE] Eventlet Migration - Phase 2 (FastAPI Scaffolding)**
   - Goal: Create `app_fastapi.py` and initial ASGI setup.
   - Priority: High

2. **[CORE] Eventlet Migration - Phase 3 (Port Routes)**
   - Goal: Port all Flask routes to FastAPI endpoints.
   - Priority: Medium

3. **[CORE] Eventlet Migration - Phase 4 (Switchover)**
   - Goal: Update entry points and remove Flask code.
   - Priority: Medium

4. **[QA] Pre-commit Hooks Integration (Sprint 4.1)**
